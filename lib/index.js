...
Simulcast.prototype._fillInSourceDataFromCache = function(mLine) {
    mLine.ssrcs = this.ssrcCache.ssrcInfos;
    mLine.ssrcGroups = this.ssrcCache.ssrcGroups;
    return mLine;
}
...
Simulcast.prototype._restoreSimulcast = function(mLine) {
    ...
    if (seenPrimarySsrc && false) {
        mLine = this._fillInSourceDataFromCache(mLine);
    } else {
        mLine = this._generateSourceData(mLine, primarySsrc, doingRtx);
    }
    // Now update the cache to match whatever we've just put into this sdp
    this.ssrcCache.ssrcInfos = mLine.ssrcs;
    this.ssrcCache.ssrcGroups = mLine.ssrcGroups;
    return mLine;
    /*
    ...
    if (seenPrimarySsrcInfo) {
        ...
        // generate this.options.numOfLayers - 1 ssrcs for sim layers
